...
class TicketQuestion(models.Model):
    ...
    ticket = models.ForeignKey(to=Ticket , related_name='questions' , on_delete=models.CASCADE , verbose_name='تیکت')
...
class TicketAnswer(models.Model):
    ...
    ticket = models.ForeignKey(to=Ticket , related_name='answers' , on_delete=models.CASCADE , verbose_name='تیکت')
    question = models.ForeignKey(to=TicketQuestion , related_name='answers' , on_delete=models.CASCADE , verbose_name='سوال')
