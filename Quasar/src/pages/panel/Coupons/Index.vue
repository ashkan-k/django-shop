  ...
  <div class="q-pa-md">
    <div class="q-gutter-y-md">
      <q-card>
        ...
        >
          <q-tab class="text-primary" name="coupons_list" icon="mdi-format-list-text" label="کد های تخفیف شما"/>
        </q-tabs>
        <q-separator/>

        <q-tab-panels v-model="tab" animated>
          <q-tab-panel name="coupons_list">
              ...
              >
                <template v-slot:body="props">
                  <q-tr :props="props">
                    ...
                    <q-td key="status">
                      <q-badge outline :color="ShowStatusColor(props.row.expiration)"
                               :label="ShowStatus(props.row.expiration)"/>
                    </q-td>
  ...
  methods: {
    ...
    DeleteCoupon (id) {
      ...
      this.$q.dialog({
        ...
        app.$axios.delete(process.env.api + 'api/panel/coupons/' + id)
          .then(function () {
    ...
    GetAllCoupons () {
      ...
      this.$axios.get(process.env.api + 'api/panel/coupons/?page=' + app.paginationPage + '&search=' + app.search)
