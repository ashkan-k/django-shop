...
export default {
  ...
  methods: {
    ...
    GetAllSuccessfulOrders () {
      ...
      this.$axios.get(process.env.api + 'api/admin/orders/successful/?page=' + app.paginationPage + '&search=' + app.search)
    ...
    GetAllUnSuccessfulOrders () {
      ...
      this.$axios.get(process.env.api + 'api/admin/orders/unsuccessful/?page=' + app.paginationPage + '&search=' + app.search)
        .then(function (response) {
          app.data = response.data.results
          app.lastPage = response.data.last_page
